...
Namespace gov.weather.www
    ...
    Partial Public Class ndfdXML
        ...
        Public Sub New()
            MyBase.New
            Me.Url = Global.RatingRulesService2.My.MySettings.Default.RatingRulesService2_gov_weather_www_ndfdXML
        ...
        Public Function NDFDgen(ByVal latitude As Decimal, ByVal longitude As Decimal, ByVal product As productType, ByVal startTime As Date, ByVal endTime As Date, ByVal weatherParameters As weatherParametersType) As <System.Xml.Serialization.SoapElementAttribute("dwmlOut")> String
            Dim results() As Object = Me.Invoke("NDFDgen", New Object() {latitude, longitude, product, startTime, endTime, weatherParameters})
            Return CType(results(0),String)
        End Function
        
        '''<remarks/>
        Public Overloads Sub NDFDgenAsync(ByVal latitude As Decimal, ByVal longitude As Decimal, ByVal product As productType, ByVal startTime As Date, ByVal endTime As Date, ByVal weatherParameters As weatherParametersType)
            Me.NDFDgenAsync(latitude, longitude, product, startTime, endTime, weatherParameters, Nothing)
        End Sub
        
        '''<remarks/>
        Public Overloads Sub NDFDgenAsync(ByVal latitude As Decimal, ByVal longitude As Decimal, ByVal product As productType, ByVal startTime As Date, ByVal endTime As Date, ByVal weatherParameters As weatherParametersType, ByVal userState As Object)
            If (Me.NDFDgenOperationCompleted Is Nothing) Then
                Me.NDFDgenOperationCompleted = AddressOf Me.OnNDFDgenOperationCompleted
            End If
            Me.InvokeAsync("NDFDgen", New Object() {latitude, longitude, product, startTime, endTime, weatherParameters}, Me.NDFDgenOperationCompleted, userState)
        End Sub
        ...
        Public Function NDFDgenByDay(ByVal latitude As Decimal, ByVal longitude As Decimal, <System.Xml.Serialization.SoapElementAttribute(DataType:="date")> ByVal startDate As Date, <System.Xml.Serialization.SoapElementAttribute(DataType:="integer")> ByVal numDays As String, ByVal format As formatType) As <System.Xml.Serialization.SoapElementAttribute("dwmlByDayOut")> String
            Dim results() As Object = Me.Invoke("NDFDgenByDay", New Object() {latitude, longitude, startDate, numDays, format})
            Return CType(results(0),String)
        End Function
        
        '''<remarks/>
        Public Overloads Sub NDFDgenByDayAsync(ByVal latitude As Decimal, ByVal longitude As Decimal, ByVal startDate As Date, ByVal numDays As String, ByVal format As formatType)
            Me.NDFDgenByDayAsync(latitude, longitude, startDate, numDays, format, Nothing)
        End Sub
        
        '''<remarks/>
        Public Overloads Sub NDFDgenByDayAsync(ByVal latitude As Decimal, ByVal longitude As Decimal, ByVal startDate As Date, ByVal numDays As String, ByVal format As formatType, ByVal userState As Object)
            ...
            End If
            Me.InvokeAsync("NDFDgenByDay", New Object() {latitude, longitude, startDate, numDays, format}, Me.NDFDgenByDayOperationCompleted, userState)
        End Sub
        ...
        '''<remarks/>
        <System.Web.Services.Protocols.SoapRpcMethodAttribute("http://www.weather.gov/forecasts/xml/DWMLgen/wsdl/ndfdXML.wsdl#NDFDgenLatLonList", RequestNamespace:="http://www.weather.gov/forecasts/xml/DWMLgen/wsdl/ndfdXML.wsdl", ResponseNamespace:="http://www.weather.gov/forecasts/xml/DWMLgen/wsdl/ndfdXML.wsdl")>  _
        Public Function NDFDgenLatLonList(ByVal listLatLon As String, ByVal product As productType, ByVal startTime As Date, ByVal endTime As Date, ByVal weatherParameters As weatherParametersType) As <System.Xml.Serialization.SoapElementAttribute("dwmlOut")> String
            Dim results() As Object = Me.Invoke("NDFDgenLatLonList", New Object() {listLatLon, product, startTime, endTime, weatherParameters})
            Return CType(results(0),String)
        End Function
        
        '''<remarks/>
        Public Overloads Sub NDFDgenLatLonListAsync(ByVal listLatLon As String, ByVal product As productType, ByVal startTime As Date, ByVal endTime As Date, ByVal weatherParameters As weatherParametersType)
            Me.NDFDgenLatLonListAsync(listLatLon, product, startTime, endTime, weatherParameters, Nothing)
        End Sub
        
        '''<remarks/>
        Public Overloads Sub NDFDgenLatLonListAsync(ByVal listLatLon As String, ByVal product As productType, ByVal startTime As Date, ByVal endTime As Date, ByVal weatherParameters As weatherParametersType, ByVal userState As Object)
            ...
            End If
            Me.InvokeAsync("NDFDgenLatLonList", New Object() {listLatLon, product, startTime, endTime, weatherParameters}, Me.NDFDgenLatLonListOperationCompleted, userState)
        End Sub
        ...
        '''<remarks/>
        <System.Web.Services.Protocols.SoapRpcMethodAttribute("http://www.weather.gov/forecasts/xml/DWMLgen/wsdl/ndfdXML.wsdl#NDFDgenByDayLatLon"& _ 
            "List", RequestNamespace:="http://www.weather.gov/forecasts/xml/DWMLgen/wsdl/ndfdXML.wsdl", ResponseNamespace:="http://www.weather.gov/forecasts/xml/DWMLgen/wsdl/ndfdXML.wsdl")>  _
        Public Function NDFDgenByDayLatLonList(ByVal listLatLon As String, <System.Xml.Serialization.SoapElementAttribute(DataType:="date")> ByVal startDate As Date, <System.Xml.Serialization.SoapElementAttribute(DataType:="integer")> ByVal numDays As String, ByVal format As formatType) As <System.Xml.Serialization.SoapElementAttribute("dwmlByDayOut")> String
            Dim results() As Object = Me.Invoke("NDFDgenByDayLatLonList", New Object() {listLatLon, startDate, numDays, format})
            Return CType(results(0),String)
        End Function
        
        '''<remarks/>
        Public Overloads Sub NDFDgenByDayLatLonListAsync(ByVal listLatLon As String, ByVal startDate As Date, ByVal numDays As String, ByVal format As formatType)
            Me.NDFDgenByDayLatLonListAsync(listLatLon, startDate, numDays, format, Nothing)
        End Sub
        
        '''<remarks/>
        Public Overloads Sub NDFDgenByDayLatLonListAsync(ByVal listLatLon As String, ByVal startDate As Date, ByVal numDays As String, ByVal format As formatType, ByVal userState As Object)
            ...
            End If
            Me.InvokeAsync("NDFDgenByDayLatLonList", New Object() {listLatLon, startDate, numDays, format}, Me.NDFDgenByDayLatLonListOperationCompleted, userState)
        End Sub
        ...
        '''<remarks/>
        <System.Web.Services.Protocols.SoapRpcMethodAttribute("http://www.weather.gov/forecasts/xml/DWMLgen/wsdl/ndfdXML.wsdl#GmlLatLonList", RequestNamespace:="http://www.weather.gov/forecasts/xml/DWMLgen/wsdl/ndfdXML.wsdl", ResponseNamespace:="http://www.weather.gov/forecasts/xml/DWMLgen/wsdl/ndfdXML.wsdl")>  _
        ...
        '''<remarks/>
        <System.Web.Services.Protocols.SoapRpcMethodAttribute("http://www.weather.gov/forecasts/xml/DWMLgen/wsdl/ndfdXML.wsdl#GmlTimeSeries", RequestNamespace:="http://www.weather.gov/forecasts/xml/DWMLgen/wsdl/ndfdXML.wsdl", ResponseNamespace:="http://www.weather.gov/forecasts/xml/DWMLgen/wsdl/ndfdXML.wsdl")>  _
        ...
        '''<remarks/>
        <System.Web.Services.Protocols.SoapRpcMethodAttribute("http://www.weather.gov/forecasts/xml/DWMLgen/wsdl/ndfdXML.wsdl#LatLonListSubgrid", RequestNamespace:="http://www.weather.gov/forecasts/xml/DWMLgen/wsdl/ndfdXML.wsdl", ResponseNamespace:="http://www.weather.gov/forecasts/xml/DWMLgen/wsdl/ndfdXML.wsdl")>  _
        ...
        '''<remarks/>
        <System.Web.Services.Protocols.SoapRpcMethodAttribute("http://www.weather.gov/forecasts/xml/DWMLgen/wsdl/ndfdXML.wsdl#LatLonListLine", RequestNamespace:="http://www.weather.gov/forecasts/xml/DWMLgen/wsdl/ndfdXML.wsdl", ResponseNamespace:="http://www.weather.gov/forecasts/xml/DWMLgen/wsdl/ndfdXML.wsdl")>  _
        ...
        '''<remarks/>
        <System.Web.Services.Protocols.SoapRpcMethodAttribute("http://www.weather.gov/forecasts/xml/DWMLgen/wsdl/ndfdXML.wsdl#LatLonListZipCode", RequestNamespace:="http://www.weather.gov/forecasts/xml/DWMLgen/wsdl/ndfdXML.wsdl", ResponseNamespace:="http://www.weather.gov/forecasts/xml/DWMLgen/wsdl/ndfdXML.wsdl")>  _
        ...
        '''<remarks/>
        <System.Web.Services.Protocols.SoapRpcMethodAttribute("http://www.weather.gov/forecasts/xml/DWMLgen/wsdl/ndfdXML.wsdl#LatLonListSquare", RequestNamespace:="http://www.weather.gov/forecasts/xml/DWMLgen/wsdl/ndfdXML.wsdl", ResponseNamespace:="http://www.weather.gov/forecasts/xml/DWMLgen/wsdl/ndfdXML.wsdl")>  _
        ...
        '''<remarks/>
        <System.Web.Services.Protocols.SoapRpcMethodAttribute("http://www.weather.gov/forecasts/xml/DWMLgen/wsdl/ndfdXML.wsdl#CornerPoints", RequestNamespace:="http://www.weather.gov/forecasts/xml/DWMLgen/wsdl/ndfdXML.wsdl", ResponseNamespace:="http://www.weather.gov/forecasts/xml/DWMLgen/wsdl/ndfdXML.wsdl")>  _
        ...
        '''<remarks/>
        <System.Web.Services.Protocols.SoapRpcMethodAttribute("http://www.weather.gov/forecasts/xml/DWMLgen/wsdl/ndfdXML.wsdl#LatLonListCityName"& _ 
            "s", RequestNamespace:="http://www.weather.gov/forecasts/xml/DWMLgen/wsdl/ndfdXML.wsdl", ResponseNamespace:="http://www.weather.gov/forecasts/xml/DWMLgen/wsdl/ndfdXML.wsdl")>  _
    ...
    <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Xml", "4.0.30319.1"),  _
     ...
     System.Xml.Serialization.SoapTypeAttribute([Namespace]:="http://www.weather.gov/forecasts/xml/DWMLgen/schema/DWML.xsd")>  _
