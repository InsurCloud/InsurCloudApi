...
Namespace gov.weather.graphical
    ...
    <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.0.30319.1"),  _
     ...
     System.Web.Services.WebServiceBindingAttribute(Name:="ndfdXMLBinding", [Namespace]:="http://graphical.weather.gov/xml/DWMLgen/wsdl/ndfdXML.wsdl")>  _
    Partial Public Class ndfdXML
        ...
        Public Sub New()
            MyBase.New
            Me.Url = Global.RatingRulesService2.My.MySettings.Default.RatingRulesService2_gov_weather_graphical_ndfdXML
        ...
        '''<remarks/>
        <System.Web.Services.Protocols.SoapRpcMethodAttribute("http://graphical.weather.gov/xml/DWMLgen/wsdl/ndfdXML.wsdl#NDFDgenByDayLatLonList"& _ 
            "", RequestNamespace:="http://graphical.weather.gov/xml/DWMLgen/wsdl/ndfdXML.wsdl", ResponseNamespace:="http://graphical.weather.gov/xml/DWMLgen/wsdl/ndfdXML.wsdl")>  _
        ...
        Public Function GmlLatLonList(ByVal listLatLon As String, ByVal requestedTime As Date, ByVal featureType As featureTypeType, ByVal Unit As unitType, ByVal weatherParameters As weatherParametersType) As <System.Xml.Serialization.SoapElementAttribute("dwGmlOut")> String
            Dim results() As Object = Me.Invoke("GmlLatLonList", New Object() {listLatLon, requestedTime, featureType, Unit, weatherParameters})
            Return CType(results(0),String)
        End Function
        
        '''<remarks/>
        Public Overloads Sub GmlLatLonListAsync(ByVal listLatLon As String, ByVal requestedTime As Date, ByVal featureType As featureTypeType, ByVal Unit As unitType, ByVal weatherParameters As weatherParametersType)
            Me.GmlLatLonListAsync(listLatLon, requestedTime, featureType, Unit, weatherParameters, Nothing)
        End Sub
        
        '''<remarks/>
        Public Overloads Sub GmlLatLonListAsync(ByVal listLatLon As String, ByVal requestedTime As Date, ByVal featureType As featureTypeType, ByVal Unit As unitType, ByVal weatherParameters As weatherParametersType, ByVal userState As Object)
        ...
        Public Function GmlTimeSeries(ByVal listLatLon As String, ByVal startTime As Date, ByVal endTime As Date, ByVal compType As compTypeType, ByVal featureType As featureTypeType, ByVal Unit As unitType, ByVal propertyName As String) As <System.Xml.Serialization.SoapElementAttribute("dwGmlOut")> String
        ...
        '''<remarks/>
        Public Overloads Sub GmlTimeSeriesAsync(ByVal listLatLon As String, ByVal startTime As Date, ByVal endTime As Date, ByVal compType As compTypeType, ByVal featureType As featureTypeType, ByVal Unit As unitType, ByVal propertyName As String)
            Me.GmlTimeSeriesAsync(listLatLon, startTime, endTime, compType, featureType, Unit, propertyName, Nothing)
        End Sub
        
        '''<remarks/>
        Public Overloads Sub GmlTimeSeriesAsync(ByVal listLatLon As String, ByVal startTime As Date, ByVal endTime As Date, ByVal compType As compTypeType, ByVal featureType As featureTypeType, ByVal Unit As unitType, ByVal propertyName As String, ByVal userState As Object)
