...
Public Class clsLogging4
    Inherits clsLogging

    Protected moPolicy As CorPolicy.clsPolicyFlood

    Public Property Policy() As CorPolicy.clsPolicyFlood
        Get
            Return moPolicy
        End Get
        Set(ByVal value As CorPolicy.clsPolicyFlood)
            moPolicy = value
        End Set
    End Property
    ...
    Public Overrides Sub GetInsertParms(ByVal sXML As System.Xml.XmlDocument, ByRef cmd As System.Data.SqlClient.SqlCommand)
        ...
        cmd.Parameters.Add("@Fees", SqlDbType.Int, 22).Value = IIf(Me.Policy.TotalFees = Nothing, DBNull.Value, Me.Policy.TotalFees)
